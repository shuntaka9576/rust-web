...
#[derive(new)]
pub struct UpdateUserPasswordRequestRequestWithUserId(UserId, UpdateUserPasswordRequest);

impl From<UpdateUserPasswordRequestRequestWithUserId> for UpdateUserPassword {
    fn from(value: UpdateUserPasswordRequestRequestWithUserId) -> Self {
        let UpdateUserPasswordRequestRequestWithUserId(
            user_id,
